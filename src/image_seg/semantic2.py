...
socket.connect("tcp://localhost:5559")  # Connect to the publisher
socket.setsockopt_string(zmq.SUBSCRIBE, "")  # Subscribe to all messages\

zmq_send_context = zmq.Context()
send_socket = zmq_send_context.socket(zmq.PUB)
send_socket.bind("tcp://*:5560")  # Binding to port 5555 for sending images


model = YOLO("./training/runs/segment/train4/weights/best.pt") 
init = True
